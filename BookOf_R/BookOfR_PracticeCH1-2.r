...
ordfac.vec <- factor(x=c("Small","Large","Large","Regular","Small"),
                     levels=c("Small","Regular","Large"),ordered=TRUE)
ordfac.vec
...
# Finding a Vector Length w/length

## I'll round off this section with the length function,
## which determines how many entries exist in a vector
## given as the argument x.
...
# 2.3.3 Subsetting & Element Extraction
